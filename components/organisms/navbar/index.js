...
export default function Navbar({ links = [] }){
  ...
  return (
    <div className='h-34 relative z-50 lg:h-55 lg:px-21 lg:flex lg:justify-around lg:items-center lg:border-b-2 lg:border-brand-semi-transparent'>
      <Link className='px-21 py-5 lg:py-0 lg:px-0 h-34 w-full lg:w-auto fixed lg:relative top-0 left-0 bg-white' href="/">
